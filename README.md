...
> **⚠️ GraphRAG health note:** As of v0.1.3, the AGE shared library auto-loading is a known gap — see [GraphRAG Infrastructure Audit](docs/GRAPHRAG_AUDIT.md) for current status. GraphRAG degrades gracefully; all other features work normally when GraphRAG is disabled.
